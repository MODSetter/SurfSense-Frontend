...
const page = () => {
  return (
    <div className="p-14 mt-14 flex flex-col gap-4">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to SurfSense.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to SurfSense, accessible from{" "}
            <a
      ...
      <ul>
        <li>By email: vermarohanfinal@gmail.com</li>
      </ul>
    </div>
  );
};
